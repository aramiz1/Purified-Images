...
public class AboutImage extends JFrame {
	...
	public AboutImage() {
		...
		String message = "Welcome! This is a very simple image storing application that I made"
				+ " using the WindowBuilder utility for Java Eclipse. " 
				...
				+ "I hope you enjoy using this small program as much as I enjoyed making it!";
