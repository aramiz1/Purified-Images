...
public class registration extends JFrame {
	...
	public void registerUser(String username, String password) {
		try {
			...
			/**
			 * (Old connection I used when I stored the information in a MySQL file
			 * on my computer instead of online. I kept this one line here
			 * for testing purposes).
			 * 
			 * Connection myConn = DriverManager.getConnection("jdbc:mysql:// localhost:3306
			 * /imageusers?autoReconnect=true&useSSL=false", "aramiz1", "donuts123");
			 */
